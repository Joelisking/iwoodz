      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          <img
            ...
            alt="iWoodz Creation — showroom interior"
        ...
        <div className="order-1 lg:order-2">
          ...
          <p className="text-ink/55 text-sm leading-relaxed mb-10 max-w-md">
            Our Accra showroom is a curated space where you can touch,
            feel, and truly live alongside our finest work. Every
            finish, every joint, every considered detail — experienced
          ...
          <div className="space-y-6 mb-11">
            {details.map(({ icon: Icon, label, lines, href }) => (
              <div key={label} className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-[10px] tracking-[0.25em] text-ink/35 uppercase mb-1">
                    {label}
                  </p>
                  {lines.map((line, i) =>
                    href && i === 0 ? (
                      ...
                      <p
                        key={line}
                        className={`text-sm ${i === 0 ? "text-ink/75" : "text-ink/40"}`}>
                        {line}
                      </p>
                    ),
                  )}
