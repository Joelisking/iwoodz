...
export function ConsultationCTAPanel() {
  return (
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <p className="text-xs uppercase tracking-[0.25em] text-ink/50 mb-4">BE INSPIRED</p>
            ...
            <p className="text-ink/60 text-sm leading-relaxed mb-8 max-w-xs mx-auto lg:mx-0">
              Browse our full portfolio of projects, materials, and finishes in our
              beautifully produced design brochure.
            </p>
